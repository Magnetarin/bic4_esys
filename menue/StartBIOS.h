...
/*
 * Schickt Daten vom Master(unserem Board) zum Slave(OLED C) über die SPI2 schnittstelle.
 *
 * @param input ... Daten die ich schicken möchte
 */
void SPI2_Write(unsigned char input);

/*
 * Verzögert das Programm um ms Millisekunden mit hilfe von
 *
 * @param ms ... Millisekunden die ich ein Programm verzögern möchte
 */
void delay_ms(double ms);

/*
 * Initialisiert alle Pins am Board die für die Kommunikation mit dem Slave(OLED C) nötig sind.
 ...
 * @param reg_value ... Wert fürs Kommandregister
 */
...
/*
 * Selectieren des Indexregisters 0x08 um dann ins DDRAM schreiben zu können.
 */
void DDRAM_access();
...
/*
 * Schreibt eine Zeile des 8x8 großen Buchstaben.
 *
...
/*
 * Schreibt einen 8x8 großen Buchstaben.
 *
